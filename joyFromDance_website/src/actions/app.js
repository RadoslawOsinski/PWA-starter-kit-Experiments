...
export const navigate = (path) => (dispatch) => {
    ...
    const page = path === '/' ? 'signup' : path.slice(1);
...
const loadPage = (page) => (dispatch) => {
    switch (page) {
        // case 'registration':
        //     import('../components/registration/registration-view.js');
        //     break;
        // case 'login':
        //     import('../components/login/login-view.js');
        //     break;
        case 'signup':
            import('../components/signup/signup.js').then((module) => {
